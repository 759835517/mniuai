...
const PATHS = [
  {
    ...
    level: "L1→L2",
    icon: "🌱",
    desc: "夯实算法与工程基础，突破1~3年工程师技术瓶颈",
    modules: ["算法基础100题", "AI编程实战", "Git工作流", "单元测试"],
    color: "green",
  },
  {
    id: "senior",
    ...
    level: "L2→L3",
    icon: "🚀",
    desc: "掌握系统设计与高并发，冲刺大厂中高级岗位",
    modules: ["算法进阶250题", "系统设计7大专题", "AI面试官陪练", "代码审查"],
    color: "orange",
    popular: true,
  },
  {
    ...
    level: "冲刺",
    icon: "🎯",
    desc: "1个月密集训练，面试前快速提分",
    modules: ["高频面试题", "大厂真题集", "20轮模拟面试", "简历优化"],
    color: "red",
  },
  {
    id: "architect",
    ...
    level: "L3→L4",
    icon: "🏛️",
    desc: "系统设计深度进阶，面向技术专家与架构师",
    modules: ["分布式系统", "高可用架构", "复杂系统设计", "技术方案评审"],
    color: "purple",
  },
];
...
export const metadata = {
  title: "学习路径",
  description: "4条经过验证的工程师能力提升路径，从初级进阶到架构师。",
};
