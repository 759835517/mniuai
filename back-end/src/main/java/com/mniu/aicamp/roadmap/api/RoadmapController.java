...
import com.mniu.aicamp.roadmap.application.RoadmapProgress;
...
public class RoadmapController {
    ...
    @PostMapping
    ApiResponse<Roadmap> generate(@Valid @RequestBody RoadmapGenerateRequest request) {
    ...
    ApiResponse<Roadmap> regenerate(@PathVariable Long roadmapId,
    ...
    ApiResponse<Roadmap> updateTask(@PathVariable Long taskId, @RequestBody UpdateProgressRequest request) {
    ...
    ApiResponse<Roadmap> updateTaskInRoadmap(@PathVariable Long roadmapId,
                                             @PathVariable Long taskId,
                                             @RequestBody UpdateProgressRequest request) {
        return ApiResponse.ok(service.updateRoadmapTask(CurrentUsers.require().id(), roadmapId, taskId, request.completed()));
    }

    @PutMapping("/{roadmapId}/progress")
    ApiResponse<RoadmapProgress> updateProgress(@PathVariable Long roadmapId,
